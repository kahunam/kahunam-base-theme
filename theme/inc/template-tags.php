...
if ( ! function_exists( 'kahu_comment_count' ) ) :
	...
	function kahu_comment_count() {
		if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
			...
			comments_popup_link( sprintf( __( 'Leave a comment<span class="sr-only"> on %s</span>', 'kahu' ), get_the_title() ) );
		}
	}
endif;
...
if ( ! function_exists( 'kahu_content_class' ) ) :
	/**
	 ...
	 * KAHU_TYPOGRAPHY_CLASSES constant.)
	 *
	 ...
	 */
	function kahu_content_class( $classes = '' ) {
		$all_classes = array( $classes, KAHU_TYPOGRAPHY_CLASSES );
